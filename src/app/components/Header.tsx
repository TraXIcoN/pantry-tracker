...
const Header: React.FC<HeaderProps> = ({ onSearch }) => {
  ...
  return (
    <div className="w-full fixed top-0 left-0 z-50 flex flex-col md:flex-row justify-center md:justify-between items-center px-2 md:px-10 py-5 bg-white">
      <div
        className="flex flex-col md:flex-row justify-center items-center gap-2 md:gap-56 cursor-pointer w-full"
      ...
      >
        ...
        >
          ...
          <span className="text-gray-500 text-sm ml-2 flex items-center whitespace-nowrap">
            Search pantry <span className="ml-1">→</span>
          </span>
        </motion.div>
        {user && (
          <motion.div
            ...
            className="relative flex-grow mx-4 mt-4 md:mt-0 w-full"
          >
            <input
              type="text"
        ...
        {!user && (
          <>
            <motion.button
              ...
              className="bg-blue-700 text-white text-xs md:text-sm font-Poppins rounded-[0.5rem] px-6 py-[0.8rem] hover:font-bold transition-all whitespace-nowrap"
            >
            ...
            <motion.button
              ...
              animate={{ opacity: 1 }}
              transition={{ duration: 0.5 }}
              className="bg-gray-200 text-black text-xs md:text-sm font-Poppins rounded-[0.5rem] px-6 py-[0.8rem] hover:bg-blue-200 hover:font-bold transition-all whitespace-nowrap"
            >
